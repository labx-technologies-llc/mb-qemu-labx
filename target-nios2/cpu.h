...
#define EXCEPTION_ADDRESS 0xC0000020 /* TODO: Get this from the device-tree ALTR,exception-addr */
#define BREAK_ADDRESS     0x00000008
#define TLB_MISS_ADDRESS  0x0000000C
...
#define   CR_PTEADDR_PTBASE_MASK (0xFFC00000)
#define   CR_PTEADDR_VPN_MASK    (0x003FFFFC)
#define CR_TLBACC    (CR_BASE + 9)
#define   CR_TLBACC_IGN_MASK (0xFE000000)
...
#define   CR_TLBMISC_WAY_MASK (0xF << 20)
#define   CR_TLBMISC_RD       (1<<19)
#define   CR_TLBMISC_WR       (1<<18)
#define   CR_TLBMISC_PID_MASK (0x3FFF << 4)
